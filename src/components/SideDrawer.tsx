      ...
      >
        <div className="relative w-screen max-w-sm pb-10 flex flex-col h-full">
          <div className="h-12 w-full flex justify-end">
            ...
            >
              <svg className="w-6 h-6" strokeWidth="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.758 17.243L12.001 12m5.243-5.243L12 12m0 0L6.758 6.757M12.001 12l5.243 5.243" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></svg>
            </button>
          </div>
          {props.children}
        </div>
